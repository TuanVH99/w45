        ...
        <>
            <Card className="" style={{ width: '15rem' }}>
                ...
                <Card.Body>
                    ...
                    <Card.Title>thoi gian tao: {props.created}</Card.Title>
